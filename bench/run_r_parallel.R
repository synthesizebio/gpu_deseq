...
output <- list(
  provenance = list(
    ...
    prepared_data_manifest_sha256 = manifest_sum,
    source_data_manifest_sha256 = source_manifest_sum,
    cpu_model = cpu_model,
...
json <- c(
  ...
  paste0("    \"prepared_data_manifest_sha256\": ",
         json_string(output$provenance$prepared_data_manifest_sha256), ","),
  paste0("    \"source_data_manifest_sha256\": ",
         json_string(output$provenance$source_data_manifest_sha256), ","),
